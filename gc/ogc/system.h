...
Introduced RCS $Id: system.h,v 1.24 2005/11/22 07:15:22 shagkur Exp $ and $Log: system.h,v $
Introduced RCS $Id$ and Revision 1.24  2005/11/22 07:15:22  shagkur
Introduced RCS $Id$ and - Added function for console window initialization
